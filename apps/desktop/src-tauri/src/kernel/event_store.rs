...
use crate::kernel::goal_lifecycle::{
    frozen_projection, projection_event, proposal_received_projection, validated_projection,
    GoalLifecycleProjection, GoalLifecycleState, GoalLifecycleStatus, GoalValidationContext,
